...
variable "identity_type" {
  description = "(Optional ) We can define type of identity used to communication with other resources. SystemAssigned or UserAssigned"
  type        = string
...
variable "automatic_channel_upgrade" {
  ...
  validation {
    ...
    error_message = "The upgrade mode is invalid. You need to choose automatic channel upgrade value from 'patch or rapid or stable'."
  }
}
...
variable "sku_tier" {
  ...
  validation {
    ...
    error_message = "The sku tier is invalid. You need to choose sku tier value from 'Free or Standard'."
  }
}
...
variable "network_policy" {
  ...
  validation {
    ...
    error_message = "The option you provided is not allowed. Please choose one of the following: \"azure\", \"calico\", \"cilium\"."
  }
}
